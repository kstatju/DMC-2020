...
result = parallel_fit(file_name_tr = "final_tr_std_promo3_tsw", file_name_ts = "final_ts_std_promo3_tsw")

path = "/work/STAT/kanak/knn/"

write.csv(x = result, file = paste(path, "knn_promo3_wolog_res1.csv", sep = ""), row.names = F)
