...
Exp_Params = list(k = c(2:40))        # list of hyper-parameters 
...
path = "/work/STAT/kanak/knn/"

write.csv(x = result, file = paste(path, "knn_promo2_log_res1.csv", sep = ""), row.names = F)
