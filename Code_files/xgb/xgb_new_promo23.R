...
Exp_Params = list(nrounds = c(1000),
                  eta = c( 0.001),  # amin .15, .2; chance: .25, saba: .3, kanak: 0.001
...
write.csv(x = result, file = paste(path, "xgb_res_promo3_final3.csv", sep = ""), row.names = F)
